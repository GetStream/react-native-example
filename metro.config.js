...
const moduleBlacklist = [
    new RegExp(repoDir + "/react-native-activity-feed/examples/.*"),
    new RegExp(repoDir + "/react-native-activity-feed/native-example/.*"),
    new RegExp(repoDir + "/react-native-activity-feed/example/.*"),
    new RegExp(repoDir + "/react-native-activity-feed/native-package/.*"),
    new RegExp(
      repoDir + "/react-native-activity-feed/expo-package/node_modules/.*"
    ),
    new RegExp(repoDir + "/react-native-activity-feed/node_modules/.*")
  ],
